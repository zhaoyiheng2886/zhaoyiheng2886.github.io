...
description: >-
  首先了解一下**流形假设**（ In machine learning, it has long been hypothesized that
  “(highdimensional) data lie (roughly) on a low-dimensional manifold”
  ，虽然原始数据看起来处在一个非常高维的
...
tags:
  ...
  - Transformer
draft: false
legacyPath: /posts/2026/03/back-to-basics-let-denoising-generative-models-denoise/
---
...
![文章配图](/images/posts/image-2026-03-25-08-40-04-008Z.png)
...
![文章配图](/images/posts/image-2026-03-25-09-13-11-599Z.png)
